...
public class SubjectViewController {
    ...
    public String addForm(Model model) {
        model.addAttribute("subject", new SubjectPostDto());
    ...
    @PostMapping("/add")
    public String addSubject(@Validated @ModelAttribute("subject") SubjectPostDto subjectPostDto, BindingResult bindingResult, RedirectAttributes redirectAttributes) {
