...
class Character {
    ...
    public void increaseStat() {
        this.HP += 10;
        System.out.println(this.name + "의 HP가 10만큼 증가했습니다.");
    }

    public void increaseStat(int amount) {
        this.HP += amount;
        System.out.println(this.name + "의 HP가 " + amount +"만큼 증가했습니다.");
    }
    ...
    public void increaseStat(int amount, String stat) {
        if(stat.equals("HP")) {
            ...
            this.AP += amount;
            System.out.println(this.name + "의 AP가 " + amount +"만큼 증가했습니다.");
        } else {
