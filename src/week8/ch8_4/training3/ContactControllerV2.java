...
public class ContactControllerV2 {
    ...
    public ResponseEntity exceptionHandle(MethodArgumentNotValidException e) {
        ...
        List<ErrorResult.FieldError> errorLogs = e.getBindingResult().getFieldErrors().stream().map(f -> new ErrorResult.FieldError (
            f.getField(), f.getRejectedValue() != null ? f.getRejectedValue().toString() : null, f.getDefaultMessage())
